...
.hero-section {
    background-image: linear-gradient(rgba(0,0,0,0.05), rgba(0,0,0,0.05)), url("../images/bg1.png");
    width: 100%;
    height: 76vh;
...
.card-1 {
  border-radius: 50% 50% 48% 52% / 55% 53% 47% 45%;
}
...
.card-3 {
  border-radius: 52% 48% 50% 50% / 47% 53% 47% 53%;
}
...
.read-more {
  ...
  color: #1b4d3e;
  text-decoration: none;
  border-bottom: 2px solid #f8d070; 
  padding-bottom: 2px;
...
.add-btn {
  ...
  box-shadow: 0 4px 12px rgba(239, 94, 65, 0.3);
}
